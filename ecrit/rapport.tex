...
Concrétement, l'équipe de SuperBeeLive va concevoir une ruche plate (figures \ref{rpz_ruche} et \ref{photo_rucher}) afin d'y mettre 
...
\large \textbf{Informations}\normalsize
    \begin{itemize}[label=\ding{238}, leftmargin=*,parsep=0cm,itemsep=0cm,topsep=0cm]
        ...
        \item "Liste Tags Appliqués" : Liste des Tags appliqués sur la vidéo.\item "Informations Vidéos" : Inforations d'où a été filmée la vidéo au moment de l'enregistrement.
        ? IDEE Ajouter "Informations Capteurs"  ?
...
un service web d'hébergement pour Git, accessible sous le nom "superbeelive". %TODO ANNEXE lien github 
...
que j'ai fais pour la première fenêtre de l'application, win\_main : \\
...
De plus, la figure %TODO 
représente cette indentation schématiquement pour visualiser ce principe de "poupées russes".
