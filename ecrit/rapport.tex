...
je me remette à niveau sur celui-ci et ai donc entamé la lecture du livre \textit{Pro Git} de Scott Chacon. %TODO 
...
Je me suis également aidée de divers tutoriels sur Internet, mais surtout de la documentation officielle. %TODO Lien biblio 
\\
...
Ce stage m'aura permit d'utiliser mes compétences acquises pendant le DUT mais aussi d'en développer d'autres grace aux activités 
que j'ai réalisé. Pour chaques missions, que ça soit la principale ou les annexes, j'ai pu apprendre sur une multitude de domaines
différents : techniques, théoriques, humains, organisationnel etc. 
Ainsi, la présentation des missions annexes et la liste des domaines où je sens que j'ai évolué semble être un bon moyen 
de présentés tous ces acquis. 
...
aussi de l'aisance. C'est avec les mises en applications de mes connaissances acquises lors du DUT que j'ai pu prendre confiance en celle-ci.
De plus, j'ai acquis un bon nombre de nouvelles connaissances, aussi bien sur le monde biologique qui entoure les abeilles que sur 
...
concrètes.\\
Ainsi, ces trois mois m'auront permit d'apprendre à travailler différement que dans un milieu scolaire. 
...
Ayant des difficultées en programmation à mon arrivée dans l'équipe, ce travail me paraissait bien plus difficile que ce qu'il 
en a été rééelement. Le fait qu'on me laisse du temps pour que je puisse me former convenablement sur le sujet m'aura été 
d'une grande aide. Par ailleurs, n'ayant pas de mal à apprendre en autodidacte, j'ai beaucoup travaillé avec des livres et
des sites internets, tous retrouvables dans la bibliographie. En plus de ces ressources, M. Druon a prit beaucoup de temps
pour répondre à mes questions et m'aider à des endroits où je bloquais, peu importe le domaine. \\

Ma participation lors des projets des premiers années aura été pour moi une expérience nouvelle et très enrichissante. Voir
...
Venant d'un Bac Littéraire, ces deux années dans un milieu plus scientifiques n'auront pas été de tout repos. Malgré les difficultées, 
j'ai pu terminer mon DUT sur un stage très intéressant et épanouissant.
C'est d'ailleurs avec une grande joie que je rejoin l'équipe de SuperBeeLive pour encore trois ans. Ma candidature pour l'école d'ingénieur
...
réseau et pouvoir commencer la vitrine web et les cartes éléctroniques.  \\
